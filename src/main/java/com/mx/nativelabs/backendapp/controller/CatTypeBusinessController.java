...
import com.mx.nativelabs.backendapp.service.impl.CatTypeBusinessServiceImpl;

@Controller
@RequestMapping(value = "/api/v1/cat-type-business")
public class CatTypeBusinessController {
	...
	public ResponseEntity<BaseResponseDTO> getByFilter(@RequestParam Map<String, String> allParams) {
		...
		try {
			...
			listDTO = this.catTypeBusinessService.getByFilter(allParams);
